...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        public GameObject mummyPlayerPrefab;
        public NetworkConnection enemy;
        ...
        List<NetworkConnection> connectionList = new List<NetworkConnection>();
        ...
        List<PendingPlayer> m_PendingPlayers;
        ...
        NetworkConnection Randomize()
        {
            // Return a random connection in the list
            int enemy = Random.Range(0, connectionList.Count);
            return connectionList[enemy];
        }
        ...
        public override GameObject OnLobbyServerCreateLobbyPlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            // Give a random connection between all player each time a new player join the lobby
            enemy = Randomize();
            return obj;
        }
        ...
        {
            // Set the right Prefab if the connection correspond to the enemy's connection
            var gamePlayer = gamePlayerPrefab;
            if (conn == enemy)
            {
                gamePlayer = mummyPlayerPrefab;
            }
            else
                gamePlayer = gamePlayerPrefab;

            // Create the player with the right prefab
            GameObject _temp = (GameObject)GameObject.Instantiate(gamePlayer,
