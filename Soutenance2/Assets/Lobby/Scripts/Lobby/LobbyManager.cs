    ...
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        void SceneLoadedForPlayer(NetworkConnection conn, GameObject lobbyPlayerGameObject)
        {
            ...
            if (gamePlayer == null)
            {
                ...
                LobbyPlayer enemy = Randomize();
                if (startPos != null)
                {
                    
                    if (lobbyPlayerGameObject == enemy)
                        gamePlayer = (GameObject)Instantiate(mummyPlayerPrefab, startPos.position, startPos.rotation);
                    else
                ...
                {
                    if (lobbyPlayerGameObject == enemy)
                        gamePlayer = (GameObject)Instantiate(mummyPlayerPrefab, Vector3.zero, Quaternion.identity);
                    else
        ...
        LobbyPlayer Randomize()
        {
            int enemy = Random.Range(0, _playerNumber + 1);
            _playersList = GetComponent<LobbyPlayerList>()._players;
            string enemyName = _playersList[enemy].playerName;
            //Display the name of the random player who will be the mummy
            return _playersList[enemy];
        }
